...
impl Default for PaperGlobalConfigUnsupportedSettings {
    fn default() -> Self {
        Self {
...
impl Default for PaperGlobalConfig {
    fn default() -> Self {
        Self {
            unsupported_settings: PaperGlobalConfigUnsupportedSettings::default(),
        }
    }
}

impl ToString for PaperGlobalConfig {
...
"#,
            self.unsupported_settings.allow_headless_pistons,
            self.unsupported_settings.allow_piston_duplication
        )
    }
}
